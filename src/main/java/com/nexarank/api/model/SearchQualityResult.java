...
public class SearchQualityResult {
    ...
    public record ModeMetrics(String label, double ndcg5, double ndcg10, double mrr10, double liftPct) {}
    public record IntentMetrics(String intent, int queryCount, double ndcg10, double mrr10) {}
